...
public class ResultOutput {
	...
	public void excelOut() throws Exception{
		...
		for(i=0;i<firstDataSet.length;i++){
			...
			series.add(Double.parseDouble(firstDataSet[i][1].substring(0,4)), Double.parseDouble(firstDataSet[i][2].substring(0,4)));
			dataset1.addSeries(series);
		}
		
		// Creating chart		
		JFreeChart scatterChart = ChartFactory.createScatterPlot("Betting Patterns", "Difference", "Payout", dataset1, PlotOrientation.HORIZONTAL, true, true, false);
		...
		for(i=0;i<secondDataSet.length;i+=10){
			for(j=0;j<noBetSites;j++){
				dataset2.setValue(Double.parseDouble(secondDataSet[count++][4]), secondDataSet[i+j][1], secondDataSet[i][0]);
			}
					
		}
		
		JFreeChart stackedChart = ChartFactory.createStackedBarChart("Betting Site Team Wise Performance", "Team", "Betting Website", dataset2, PlotOrientation.HORIZONTAL, true, true, false);
		...
		JFreeChart barChart = ChartFactory.createBarChart("Home Away Performance", "Team", "Performace", dataset3, PlotOrientation.VERTICAL, true, true, false);
		...
		renderer3.setBasePositiveItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12,TextAnchor.BASELINE_CENTER));
		renderer3.setBaseNegativeItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12,TextAnchor.BASELINE_CENTER));
		...
		JFreeChart stackedChart2 = ChartFactory.createStackedBarChart("Half Time Full Time Relation", "Team", "Relation", dataset4, PlotOrientation.VERTICAL, true, true, false);
		...
		renderer4.setBasePositiveItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12,TextAnchor.BASELINE_CENTER));
		renderer4.setBaseNegativeItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12,TextAnchor.BASELINE_CENTER));
